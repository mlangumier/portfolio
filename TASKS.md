...
- [ ] Reorganize project structure to account for both:
  ...
  - [ ] Projects with different styles: each project will have its own TailwindCSS stylesheet (-> each their own route ? Can stylesheet take priority upon parent?) (-> TODO: tests)

- [ ] Add first project (TBD: WorkShpere or MapLibre)
- [ ] Add another public page (TBD: "/about" or "/contact")

#### Update Project Structure

- [ ] Routes - Reorganize routes allow multiple RootLayouts (one for `main` & one for each project-page (TBD)) -> [Documentation](https://nextjs.org/docs/app/getting-started/project-structure#creating-multiple-root-layouts)
- [ ] Theme - Move `Tailwind CSS` stylesheet to related route -> keep style to the route it affects
