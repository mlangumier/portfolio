  ...
  return (
    <div
      ...
      className={cn(
        ...
        'before:absolute before:inset-0 before:ml-3 before:h-full before:w-0.5 before:-translate-x-px before:bg-linear-to-b before:from-transparent before:via-accent before:to-transparent md:before:mx-auto md:before:translate-x-0'
      )}
    >
